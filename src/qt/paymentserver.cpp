...
const QString BITCOIN_IPC_PREFIX("elcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click elcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start elcoin: click-to-pay handler");
    else
...
{
    // clicking on elcoin: URLs creates FileOpen events on the Mac:
