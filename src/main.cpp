...
#if defined(NDEBUG)
# error "Elcoin cannot be compiled without assertions."
#endif
...
unsigned int nMaxTipAge = 7 * 24 * 60 * 60; // 1 week
...
const string strMessageMagic = "Elcoin Signed Message:\n";
...
void RegisterWallet(CWalletInterface* pwalletIn) {
    g_signals.UpdatedBlockTip.connect(boost::bind(&CWalletInterface::UpdatedBlockTip, pwalletIn, _1));
...
void UnregisterWallet(CWalletInterface* pwalletIn) {
    ...
    g_signals.UpdatedBlockTip.disconnect(boost::bind(&CWalletInterface::UpdatedBlockTip, pwalletIn, _1));
}
    ...
    const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, unsigned int flags)
{
    ...
    // fMiner is true when called from the internal Elcoin miner
...
bool CBlock::SetBestChain(CTxDB& txdb, CBlockIndex* pindexNew)
{
    ...
    g_signals.UpdatedBlockTip(pindexBest);
