...
static const int64_t UNLOCK_YEAR_REWARD = 5 * CENT; // 5% unlock reward per year
...
public:
    ...
    /** Amount of elcoins spent by this transaction.
    ...
    /** Amount of elcoins coming in to this transaction
...
protected:
    ...
    virtual void SyncTransaction(const CTransaction &tx, const CBlock *pblock, bool fConnect) {}
