...
# also add new translations to src/qt/elcoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/elcoin_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/elcoin.rc
...
windows:RC_FILE = src/qt/res/elcoin.rc
...
macx:ICON = src/qt/res/icons/elcoin.icns
macx:TARGET = "elcoin"
